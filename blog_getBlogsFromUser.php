...
echo "<form action='blog_userSettings.php?page=settings' method='post'>Vilken blogg vill du ändra? <select name='blogID' id='blogID' class='formText' required='required'>";
